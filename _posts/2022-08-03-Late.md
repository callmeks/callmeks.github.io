...
title: Late
subtitle: Machine
tags: [HackTheBox,Easy,Linux,Privilege Escalation,SSTI Injection,RCE]
---
# Late
- Difficulty : `Easy`
...
<br>![image](https://user-images.githubusercontent.com/88197307/182519996-b038750d-9bfd-4e15-abb0-70194273ff78.png)
<br>
After looking around the website, one interesting information that we managed to found is a suspicious link.
<br>
![image](https://user-images.githubusercontent.com/88197307/182520653-0ee92b6a-d749-4d55-ab79-05275cff06a1.png)
<br>
...
<br>
![image](https://user-images.githubusercontent.com/88197307/182521457-78f77a4c-ec98-441d-9191-a15c45873637.png)
<br>
...
<br>
Example image:
![image](https://user-images.githubusercontent.com/88197307/182522519-1006f0a3-3dbd-4281-8133-8d2066e11290.png)
<br>
Result:
```
cat results.txt 
...
Example:
<br>
![image](https://user-images.githubusercontent.com/88197307/182523243-4cbcbc24-2be1-45a3-81be-858a937fa104.png)
<br>
Result:
```
cat results.txt 
...
Example:
<br>
![image](https://user-images.githubusercontent.com/88197307/182523587-c3e6e5b4-ed56-40f9-bc8e-19d603f49b74.png)
<br>
Result:
```
cat results.txt 
...
Example:
<br>
![image](https://user-images.githubusercontent.com/88197307/182524268-9344d33c-61b6-4477-97aa-e7e828a3c444.png)
<br>
Result:
```
 cat results.txt 
...
<br>
Example:
![image](https://user-images.githubusercontent.com/88197307/182524498-e9981c14-45dd-4524-8a04-2450ddeb7fae.png)
<br>
Result:
```
cat results.txt 

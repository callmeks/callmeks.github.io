...
tags: [OSCP,Vulnhub,Linux,SMB outdated version]
---
...
## IP Discovery
VM from vulnhub requried own configuration. Use `netdiscover`, `arp-scan` or `nmap` to check for ip address. If no address is found, check your configuration on the vm.
```
 ...
 10.0.2.3        08:00:27:72:9d:d2      1      60  PCS Systemtechnik GmbH       
 10.0.2.15       08:00:27:6d:87:28      1      60  PCS Systemtechnik GmbH  
```
